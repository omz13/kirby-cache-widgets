...
if (!$has_php_extension)
{
  return array(
    'title'   => $title,
    'compressed' => true,
    'html' => function() { return 'Required php extension not loaded'; }
    );
}
...
(
  ...
  'html' => function()
  {
    $res='Active. No more information is available.';
